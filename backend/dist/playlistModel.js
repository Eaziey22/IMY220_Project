...
var playlistModel = exports.playlistModel = /*#__PURE__*/function () {
  function playlistModel(dbName) {
  ...
  return _createClass(playlistModel, [{
    ...
    key: "getPlaylistById",
    value: function () {
      var _getPlaylistById = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(playlistId) {
        var playlist;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 2:
              ...
              return _context2.abrupt("return", playlist);
            case 4:
            case "end":
