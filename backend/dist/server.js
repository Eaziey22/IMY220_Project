...
app.get("/playlist/getPlaylistSongs/:playlistId", /*#__PURE__*/function () {
  var _ref18 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee18(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 33:
          ...
          console.log("Error getting songs from playlist by id: ".concat(_context18.t1));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
    ...
    }, _callee18, null, [[1, 33], [10, 22, 25, 28]]);
  }));
    ...
    return _regeneratorRuntime().wrap(function _callee19$(_context19) {
      while (1) switch (_context19.prev = _context19.next) {
        ...
        case 12:
          ...
          console.log("Error getting user songs: ".concat(_context19.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
