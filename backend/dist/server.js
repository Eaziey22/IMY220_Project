...
app.put("user/:userId/addFriend/:friendId", /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _req$params, userId, friendId, result, updatedUser;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 15:
          ...
          console.log("Error adding friend: ".concat(_context6.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app.put("user/:userId/removeFriend/:friendId", /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$params2, userId, friendId, result, updatedUser;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          _req$params2 = req.params, userId = _req$params2.userId, friendId = _req$params2.friendId;
          _context7.prev = 1;
          if (!(!_mongodb.ObjectId.isValid(userId) || !_mongodb.ObjectId.isValid(friendId))) {
            _context7.next = 4;
            break;
        ...
        case 15:
          ...
          console.log("Error removing friend: ".concat(_context7.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app.post("/playlists/createPlaylist", /*#__PURE__*/function () {
  var _ref8 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee8(req, res) {
    var _req$body3, playlistName, ownerId, songs, pl;
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 10:
          ...
          console.log("Error creating a new playlist: ".concat(_context8.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 12:
          ...
          console.log("Error getting playlist by id: ".concat(_context9.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app.put("/playlists/updatePlaylist/:id", /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        ...
        case 12:
          ...
          console.log("Error updating playlist: ".concat(_context11.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app.put("/playlists/addSong/:playlistId/songs/:songId", /*#__PURE__*/function () {
  var _ref12 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee12(req, res) {
    var _req$params3, playlistId, songId, modifiedCount;
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 10:
          ...
          console.log("Error adding song to playlist: ".concat(_context12.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app.put("/playlists/removeSong/:playlistId/songs/:songId", /*#__PURE__*/function () {
  var _ref13 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee13(req, res) {
    var _req$params4, playlistId, songId, modifiedCount;
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        ...
        case 10:
          ...
          console.log("Error removing song from playlist: ".concat(_context13.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app["delete"]("/playlists/deletePlaylist/:ownerId/:id", /*#__PURE__*/function () {
  var _ref14 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee14(req, res) {
    var _req$params5, ownerId, id, result;
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          _req$params5 = req.params, ownerId = _req$params5.ownerId, id = _req$params5.id;
          _context14.prev = 1;
        ...
        case 14:
          ...
          console.log("Error deleting playlist: ".concat(_context14.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app.post("/songs/addSong", /*#__PURE__*/function () {
  var _ref15 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee15(req, res) {
    var _req$body4, name, artistName, genre, album, song, ownerId, addedSong;
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          _req$body4 = req.body, name = _req$body4.name, artistName = _req$body4.artistName, genre = _req$body4.genre, album = _req$body4.album, song = _req$body4.song, ownerId = _req$body4.ownerId;
          _context15.prev = 1;
          _context15.next = 4;
          return Song.addSong(name, artistName, genre, album, song, ownerId);
        case 4:
          addedSong = _context15.sent;
          _context15.next = 7;
        ...
        case 10:
          ...
          console.log("Error adding song: ".concat(_context15.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
...
app["delete"]("/songs/deleteSong/:ownerId/:songId", /*#__PURE__*/function () {
  var _ref16 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee16(req, res) {
    var _req$params6, ownerId, songId, dCount;
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          _req$params6 = req.params, ownerId = _req$params6.ownerId, songId = _req$params6.songId;
          _context16.prev = 1;
        ...
        case 14:
          ...
          console.log("Error deleting song: ".concat(_context16.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
    ...
    return _regeneratorRuntime().wrap(function _callee17$(_context17) {
      while (1) switch (_context17.prev = _context17.next) {
        ...
        case 12:
          ...
          console.log("Error getting song by id: ".concat(_context17.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 12:
          ...
          console.log("Error getting user songs: ".concat(_context18.t0));
          res.status(500).json({
            status: "error",
            message: "Internal server error"
          });
